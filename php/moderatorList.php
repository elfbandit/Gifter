...
$result = mysql_query("SELECT CONCAT( firstName,  ' ', lastName ) AS 'name', user.userId, permission FROM exchangeUser JOIN  user on exchangeUser.userId=user.userId WHERE exchangeId=" . $_POST['exchangeId']);
